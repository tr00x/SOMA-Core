...
class TestComputeSignalPressure:
    ...
    def test_std_zero_uses_epsilon(self):
        """std=0 → max(0, 1e-9) used as denominator; large z clamps to 1.0."""
        result = compute_signal_pressure(current=1.0, baseline=0.5, std=0.0)
