...
- Key thresholds (guide, warn, block)
- Budget limits
...
| Mode | Description |
|------|-------------|
| **strict** | Low thresholds, tight pressure boundaries, all validation on, verbose output. For critical work. |
| **relaxed** | Default. Balanced thresholds, guidance-based monitoring. Good for normal coding. |
| **autonomous** | High thresholds, minimal guidance, no quality tracking. For trusted autonomous runs. |
...
Valid thresholds: guide, warn, block.
...
/soma:config threshold warn 0.50
